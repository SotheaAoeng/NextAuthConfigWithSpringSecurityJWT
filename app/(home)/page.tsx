const Home = () => {
    ...
    return(
        ...
        //     <h1 className="text-3xl font-semibold mb-6 text-black text-center">WELCOME TO ME REAN KH</h1>
        // </div>
        ...
        <>
          ...
          <span className="mx-auto text-xl font-black leading-none text-gray-900 select-none">
              លក់ដូងទុំ<span className="text-indigo-600">.</span>
          </span>
                        </a>
                    ...
                    <div className="flex flex-wrap items-center sm:-mx-3">
                        <div className="w-full md:w-1/2 md:px-3">
                            <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                                <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                                    <span className="block xl:inline">សូមស្វាគមន៍</span><br/>
                                    <span className="block text-indigo-600 xl:inline">មកកាន់គេហទំព័រលក់ដូងទុំនៅកម្ពុជា</span>
                                </h1>
                                <p className="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                                    យើងខ្ញុំផ្តល់សេវាកម្មដល់អដិជន២៥ខេត្តក្រុងនៅកម្ពុជា។
                                </p>
                        ...
                        <div className="w-full md:w-1/2">
                            <div className="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                                <img width={600} height={200} src="https://img2.exportersindia.com/product_images/bc-full/2018/7/5625226/fresh-husked-coconuts-1532510151-4135998.jpeg" alt=""/>
                            </div>
                        </div>
                    </div>
                </div>
